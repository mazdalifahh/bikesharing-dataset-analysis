...
season_option = st.sidebar.multiselect("Pilih Musim", options=df_day['season_name'].unique(), default=list(df_day['season_name'].unique()))
weather_option = st.sidebar.multiselect("Pilih Cuaca", options=df_day['weather_desc'].unique(), default=list(df_day['weather_desc'].unique()))
usage_option = st.sidebar.multiselect("Pilih Kategori Penyewaan", options=df_day['usage_category'].unique(), default=list(df_day['usage_category'].unique()))
...
sns.lineplot(data=df_filtered, x='month', y='cnt', hue='year', marker="o")
...
# Visualisasi Boxplot - Penyewaan per Hari dalam Seminggu
